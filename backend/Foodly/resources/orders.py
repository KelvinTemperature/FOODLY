...
from order_store import create_order, delete_order, get_order, list_orders, replace_order
...
class Order(MethodView):
    ...
    def put(self, order_data, order_id):
        try:
            ...
            saved_order = replace_order(order_id, order)
            if not saved_order:
                abort(404, message='Order not found')
...
class OrderList(MethodView):
    ...
    def post(self, order_data):
        try:
            ...
            saved_order = create_order(new_order)
